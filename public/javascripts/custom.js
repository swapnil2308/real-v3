function functionInTest(){
  onClick="window.location.reload(true)"
   ...
   function inputWords () {
     letters = document.getElementById("words").value  ;
     console.log(letters);
     }
   // debugger     ;
  ...
  //  init();
    ...
    function doIt() {
        ...
        // $('#imageID').prepend(image);
    }

  $('#inputWordsID').on("click", function() {
                inputWords();
               init();
            }); 

           // $value.append($firstButtonObj);

                         //
            //debugger;
            //$buttonObj = $('<button>').text( "Create image").on("click", function() {
           $('#doItID').on("click", function() {
                doIt();
            });  
